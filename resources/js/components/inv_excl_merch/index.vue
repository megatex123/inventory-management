<template>
  <div class="container-fluid my-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        <h2 class="mb-1"><i class="fas fa-boxes text-primary mr-2"></i>QuiviMerch Exclusive Inventory</h2>
        <p class="text-muted mb-0">Collector's-Edition-exclusive merch stock pool</p>
      </div>
      <router-link to="/inv-excl-merch/create" class="btn btn-primary">
          ...
          <table class="table table-hover mb-0">
            ...
            <tbody v-else>
              <tr v-for="(item, index) in items" :key="item.id">
                ...
                <td class="align-middle">{{ item.inv_excl_merch_id }}</td>
                ...
                <td class="align-middle text-center">
                  <div class="btn-group">
                    <router-link :to="`/inv-excl-merch/edit/${item.id}`" class="btn btn-sm btn-outline-warning" title="Edit"><i class="fas fa-edit"></i></router-link>
  ...
  methods: {
    async fetchItems() {
      ...
      try {
        ...
        const res = await axios.get('/api/inv-excl-merch', { params });
    ...
    async fetchStatistics() {
      try {
        const res = await axios.get('/api/inv-excl-merch/statistics');
    ...
    deleteItem(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios.delete(`/api/inv-excl-merch/${id}`)
            .then(() => {
