                            ...
                            <div class="card">
                                ...
                                <div class="card-header py-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <h5 class="m-0 font-weight-bold text-primary text-center flex-grow-1">Category List</h5>
    ...
    methods: {
        ...
        extractFilterOptions() {
            ...
            this.categories.forEach(category => {
                ...
                if (category.code && category.code.length > 0) {
                    const firstLetter = category.code.charAt(0).toUpperCase();
                    if (/[A-Z0-9]/.test(firstLetter)) {
        ...
        sortCategories(categories) {
            switch (this.filters.sortBy) {
                ...
                case 'code_asc':
                    return categories.slice().sort((a, b) => (a.code || '').localeCompare(b.code || ''));
                case 'code_desc':
                    return categories.slice().sort((a, b) => (b.code || '').localeCompare(a.code || ''));
                case 'date_asc':
    ...
    computed: {
        filteredCategories() {
            ...
            if (this.filters.codeStartsWith) {
                filtered = filtered.filter(category =>
                    category.code &&
                    category.code.charAt(0).toUpperCase() === this.filters.codeStartsWith
                );
            }
