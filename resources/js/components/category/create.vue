                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header py-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <h5 class="m-0 font-weight-bold text-primary text-center mb-2">Create New Category</h5>
                                                <p class="text-muted text-center small mb-0">Add a new category to your system</p>
                                            </div>
                                            ...
                                            <div class="card shadow-sm">
                                                <div class="card-body">
                                                    <form class="user" @submit.prevent='CategoryInsert' enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="small font-weight-bold text-muted">Category Code *</label>
                                                            <input
                                                                type="text"
                                                                class="form-control form-control-lg"
                                                                v-model='form.code'
                                                            ...
                                                            <small class="form-text text-muted">
                                                                Use short, unique code (e.g., ELEC for Electronics, CLOTH for Clothing)
                                                            </small>
                                                        </div>
