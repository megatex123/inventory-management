                            ...
                            <div class="col-lg-7 m-auto">
                                <div class="login-form">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Update QuiviCare</h1>
                                    </div>
                                    <form class="user" @submit.prevent='CareUpdate' enctype="multipart/form-data">
...
<script>
    export default {
        ...
        methods: {
            CareUpdate(){
                let id = this.$route.params.id
            axios.patch('/api/care/'+id,this.form)
                    .then( () => {
