                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header py-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <h5 class="m-0 font-weight-bold text-primary text-center mb-2">Update Brand</h5>
                                                <p class="text-muted text-center small mb-0">Edit Brand details</p>
                                            </div>
        ...
        fetchCategory() {
            ...
            axios.get('/api/brand/' + id)
                ...
                .catch(err => {
                    ...
                    notification.error('Failed to load Brand data');
                });
        },
