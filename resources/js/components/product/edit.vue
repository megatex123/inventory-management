                                ...
                                <div class="login-form">
                                    ...
                                    <form class="user" @submit.prevent='ProductUpdate' enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="photo-upload-btn" :class="{ 'has-photo': form.image }" title="Click to change photo">
                                            ...
                                            <small class="text-muted d-block" v-if='form.image'>Click the photo above to replace it</small>
