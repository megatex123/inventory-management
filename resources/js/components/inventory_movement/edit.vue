    ...
    <div class="card shadow-sm form-card">
      <div class="card-header bg-warning text-white">
        <div class="d-flex justify-content-between align-items-center">
          <h4 class="mb-0"><i class="fas fa-edit mr-2"></i>Edit Inventory Movement</h4>
      ...
      <div class="card-body">
        ...
        <form v-else @submit.prevent="submit">
          <div class="form-group">
            ...
            <input type="text" :value="movementId" class="form-control bg-light" readonly>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" v-model="form.sku_code" class="form-control" list="sku-suggestions" required maxlength="50" @change="onSkuChange">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" v-model="form.destination" class="form-control" list="destination-suggestions" required maxlength="255">
          ...
          <div class="form-actions mt-4 pt-3 border-top">
            <button type="submit" class="btn btn-primary" :disabled="loading">
              ...
              <i v-else class="fas fa-save mr-2"></i> Update Movement
            </button>
          </div>
        </form>
      </div>
...
export default {
  ...
  methods: {
    ...
    async fetchMovement() {
      ...
      try {
        const res = await axios.get(`/api/inventory-movements/${this.$route.params.id}`);
        const record = res.data.data;
        const masterSku = record.master_sku || record.masterSku;
        const destination = record.destination;

        this.movementId = record.movement_id;
        this.form = {
          date: record.date ? record.date.split('T')[0].split(' ')[0] : '',
          sku_code: masterSku ? masterSku.sku_code : '',
          item_name: record.item_name || (masterSku ? masterSku.product_name : ''),
        ...
        Swal.fire('Error!', 'Failed to load movement', 'error').then(() => this.$router.push('/inventory-movements'));
      } finally {
    ...
    submit() {
      ...
      axios.put(`/api/inventory-movements/${this.$route.params.id}`, this.form)
        .then(() => {
          Swal.fire({ title: 'Success!', text: 'Movement updated successfully', icon: 'success', timer: 1500, showConfirmButton: false })
        ...
        .catch(error => {
          if (error.response && error.response.status === 422) {
            ...
            this.errors.push(error.response?.data?.message || 'Failed to update movement');
          }
