                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header py-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <h5 class="m-0 font-weight-bold text-primary text-center mb-2">Update Sub Category</h5>
                                                <p class="text-muted text-center small mb-0">Edit sub category details</p>
                                            </div>
                                    ...
                                    <div class="row px-3 mt-4">
                                        <div class="col-lg-7 m-auto">
                                            <div class="card shadow-sm">
                                                <div class="card-body">
                                                    <form class="user" @submit.prevent='SubCategoryUpdate' enctype="multipart/form-data">
...
export default {
    created() {
        ...
        // Get current sub category ID from route
        const id = this.$route.params.id;

        // Fetch the sub category to edit
    ...
    methods: {
        fetchSubCategory(id) {
            axios.get('/api/sub-categories/' + id)
                ...
                .catch(err => {
                    ...
                    notification.error('Failed to load sub category data');
                });
        },
        ...
        SubCategoryUpdate() {
            ...
            axios.patch('/api/sub-categories/' + id, this.form)
                .then(() => {
