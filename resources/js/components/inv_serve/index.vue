<template>
  <div class="container-fluid my-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        <h2 class="mb-1"><i class="fas fa-boxes text-primary mr-2"></i>QuiviServe Inventory</h2>
        <p class="text-muted mb-0">Stock of QuiviServe packaging/perk items (boxes, perk cards, etc.)</p>
      </div>
      <router-link to="/inv-serve/create" class="btn btn-primary">
          ...
          <table class="table table-hover mb-0">
            <thead class="thead-light">
              <tr>
                ...
                <th class="text-right">To Restock</th>
                <th>Status</th>
            ...
            <tbody v-else>
              <tr v-for="(item, index) in items" :key="item.id">
                ...
                <td class="align-middle">
                  <span :class="item.status == 1 ? 'badge badge-success' : 'badge badge-secondary'">{{ item.status == 1 ? 'Active' : 'Inactive' }}</span>
                </td>
                <td class="align-middle text-center">
                  <div class="btn-group">
                    <router-link :to="`/inv-serve/edit/${item.id}`" class="btn btn-sm btn-outline-warning" title="Edit"><i class="fas fa-edit"></i></router-link>
...
export default {
  ...
  methods: {
    ...
    fetchList() {
      ...
      axios.get('/api/inv-serve', { params })
        .then(res => {
    ...
    fetchStatistics() {
      axios.get('/api/inv-serve/statistics')
        .then(res => {
