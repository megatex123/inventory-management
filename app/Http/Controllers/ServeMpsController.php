        ...
        try {
            ...
            foreach ($serveMps->items() as $item) {
                ...
                $transformedData[] = [
                    ...
                    'two_free_onsite_troubleshooting_claim_1_date' => $item->two_free_onsite_troubleshooting_claim_1_date,
                    'two_free_onsite_troubleshooting_claim_2' => (bool)$item->two_free_onsite_troubleshooting_claim_2,
                    'two_free_onsite_troubleshooting_claim_2_date' => $item->two_free_onsite_troubleshooting_claim_2_date,
                    ...
                    'two_advance_cable_management_claim_1_date' => $item->two_advance_cable_management_claim_1_date,
                    'two_advance_cable_management_claim_2' => (bool)$item->two_advance_cable_management_claim_2,
                    'two_advance_cable_management_claim_2_date' => $item->two_advance_cable_management_claim_2_date,
                    ...
                    'rm100_promo_code_next_build' => $item->rm100_promo_code_next_build, // UPDATED FIELD
    ...
    public function show($id)
    {
        try {
            ...
            $responseData = [
                ...
                'date_start' => $serveMps->date_start,
                ...
                'two_free_onsite_troubleshooting_claim_1_date' => $serveMps->two_free_onsite_troubleshooting_claim_1_date,
                'two_free_onsite_troubleshooting_claim_2' => (bool)$serveMps->two_free_onsite_troubleshooting_claim_2,
                'two_free_onsite_troubleshooting_claim_2_date' => $serveMps->two_free_onsite_troubleshooting_claim_2_date,
                ...
                'two_advance_cable_management_claim_1_date' => $serveMps->two_advance_cable_management_claim_1_date,
                'two_advance_cable_management_claim_2' => (bool)$serveMps->two_advance_cable_management_claim_2,
                'two_advance_cable_management_claim_2_date' => $serveMps->two_advance_cable_management_claim_2_date,
                ...
                'rm100_promo_code_next_build' => $serveMps->rm100_promo_code_next_build, // UPDATED FIELD
